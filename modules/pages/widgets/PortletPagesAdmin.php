...
class PortletPagesAdmin extends Portlet
{
	...
	protected function renderContent()
	{
		if($this->menuItems==null){
			...
			$this->menuItems[] = array('label'=>Yii::t('app','new page entry'),'link'=>Html::url(array('/pages/page/create')),'icon'=>'icon-plus');
			$this->menuItems[] = array('label'=>Yii::t('app','overview'),'link'=>Html::url(array('/pages/page/index')),'icon'=>'icon-list-alt');
		}
