...
class DefaultController extends Controller
{
  ...
  public function actionDhtmlxgridworkflow($un=NULL, $posStart=0, $count=0,$search=NULL,$mainid = null){
    ...
    foreach($provider->getModels() AS $record){
      if(!is_null($record))
      {
        $record['approvallink'] = Html::url(['/purchase/purchase-order-line/window','id'=>$record['id'],'win'=>'purchaseOrderLine_approveajax','mainid'=>$mainid]);
        $record['rejectedlink'] = Html::url(['/purchase/purchase-order-line/window','id'=>$record['id'],'win'=>'purchaseOrderLine_rejectajax','mainid'=>$mainid]);        
  ...
  public function actionDhtmlxgridegpdetail($un=NULL, $posStart=0, $count=0,$search=NULL,$mainid = null){
    ...
    foreach($provider->getModels() AS $record){
      if(!is_null($record))
      {
        $record['updatelink'] = Html::url(['/purchase/purchase-order-line/window','id'=>$record['id'],'win'=>'purchaseOrderLine_update','mainid'=>$mainid]);
        $record['approvallink'] = Html::url(['/purchase/purchase-order-line/window','id'=>$record['id'],'win'=>'purchaseOrderLine_purchaseajax','mainid'=>$mainid]);
        $record['rejectedlink'] = Html::url(['/purchase/purchase-order-line/window','id'=>$record['id'],'win'=>'purchaseOrderLine_rejectajax','mainid'=>$mainid]);        
        //styling the background
