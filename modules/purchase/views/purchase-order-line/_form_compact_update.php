...
<div class="purchase-order-line-form">
	...
	<?php $form = ActiveForm::begin([
		...
		'action' => Html::Url(['/purchase/purchase-order-line/update','id'=>$model->id]),
...
$url = Html::url(['/parties/contact/jsonlist']);
      ...
      <?= $form->field($model, 'article')->widget(Typeahead::classname(),[
            ...
            'dataset' => [
              [
                ...
                'remote' => \Yii::$app->controller->createUrl('/purchase/purchase-order-line/jsonlist') . '&search=%QUERY',
                'limit' => 10
              ]
            ]
      ]); ?>
